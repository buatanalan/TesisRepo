...
if args.mode == "pretrain_specialist":
    ...
    TAG_ARM = f"master_hybrid_ppo_specialist{args.stream_select}_{STREAM_NAME}{_horizon_suffix}"
else:
    TAG_ARM = f"master_hybrid_ppo_dgr{_horizon_suffix}"
...
def _specialist_tag(stream: int, explicit: str):
    ...
    return f"master_hybrid_ppo_specialist{stream}_{name}{_horizon_suffix}"
