#!/bin/bash
# Evaluasi metrik kaya utk checkpoint retrain_h6b_latectx_stattn.sh (30d & 90d).
...
$PY $UJI 0,1,2 90d master_ev_ppo_pref_feat_small_latectx_nohist_acc1_stattn_vwf_seimbang4x_K3_gap_sig1_90d
