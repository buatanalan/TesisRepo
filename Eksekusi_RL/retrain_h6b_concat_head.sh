...
# ditambah --reward-preset seimbang4x --forecaster vwf (baku Eksekusi_RL). 30d & 90d.
...
COMMON="--pref --pref-feature-mode --alpha-accept 1.0 --no-hist --n-critics 3 --beta-mode gap_ratio --beta-sigma 1.0 --reward-preset seimbang4x --forecaster vwf --use-concat-head --concat-attn-dim 8 --concat-mlp-hidden 32"
